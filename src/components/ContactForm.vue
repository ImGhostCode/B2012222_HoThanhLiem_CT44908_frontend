<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema">
        ...
        <div class="form-group">
            ...
            <button v-if="contactLocal._id" type="button" class="ms-3 btn btn-danger" @click="deleteContact">
                Xóa
            </button>
            <router-link class="btn btn-warning float-end" :to="{ name: 'contactbook' }">Trờ về</router-link>
        </div>
    </Form>
</template>
<script>
